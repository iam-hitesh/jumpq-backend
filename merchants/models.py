...
class Store(models.Model):
    ...
    store_map_url = models.URLField(blank=True)
    head = models.ManyToManyField(users.models.User)
    ...
    store_contact = models.BigIntegerField(db_index=True)
