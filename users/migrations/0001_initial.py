    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('token_type', models.IntegerField(choices=[(1, 'Email Confirmation'), (2, 'Mobile Confirmation'), (3, 'Forgot Password'), (4, 'Login'), (5, 'Order Confirm')], db_index=True, default=1)),
                ('is_used', models.BooleanField(db_index=True, default=False)),
                ('expire_on', models.DateTimeField(auto_now=True)),
                ('created_at', models.DateTimeField(default=django.utils.timezone.now)),
                ('updated_at', models.DateTimeField(auto_now=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(default=django.utils.timezone.now)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('state', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='users.Countries')),
            ],
            options={
                'verbose_name': 'City',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('landmark', models.CharField(default='', max_length=255, null=True)),
